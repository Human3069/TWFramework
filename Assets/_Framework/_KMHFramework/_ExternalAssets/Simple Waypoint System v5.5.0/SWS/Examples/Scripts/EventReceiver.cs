...
public class EventReceiver : MonoBehaviour
{
    ...
    public virtual void SetDestination(Object target)
    {
        StartCoroutine(SetDestinationRoutine(target));
    }

    protected virtual IEnumerator SetDestinationRoutine(Object target)
    {
        //get references
    ...
    public virtual void ActivateForTime(Object target)
    {
        StartCoroutine(ActivateForTimeRoutine(target));
    }

    protected IEnumerator ActivateForTimeRoutine(Object target)
    {
        GameObject tar = (GameObject)target as GameObject;
        tar.SetActive(true);

...
namespace SWS
{
    ...
    {
        //manager reference
        protected WaypointManager script;
		//new path name
        ...
        protected void PlaceWaypoint(Vector3 placePos)
        {
        ...
        protected void PlaceBezierPoint(Vector3 placePos)
        {
